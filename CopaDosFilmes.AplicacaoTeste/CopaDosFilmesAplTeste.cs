...
namespace CopaDosFilmes.AplicacaoTeste
{
    public class CopaDosFilmesAplTeste
    {
        private List<Filme> _filmes;
        private ICopaDosFilmesApl filmeApl;

        public CopaDosFilmesAplTeste()
        {
            ...
            filmeApl = new CopaDosFilmesApl(new CopaDosFilmesRepositorio());
        }
        ...
        public void Verificar_se_retorna_resultado_recebendo_oito_filmes()
        {
            ...
            var resultado = filmeApl.GerarMeuCampeonato(filmes);
        ...
        public void Verificar_se_retorna_erro_se_nao_receber_todos_os_times()
        {
            ...
            Assert.Throws<Exception>(() => filmeApl.GerarMeuCampeonato(filmes));
        }
        ...
        public void Verificar_se_esta_retornando_a_lista_de_filmes()
        {
            ...
            filmeApl = new CopaDosFilmesApl(mock.Object);
            var resultado = filmeApl.ListarFilmes();
